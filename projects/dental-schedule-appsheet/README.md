...
| 患者不在時間 | `data-model/csv-data/患者不在時間.csv` |
| 日別訪問計画 | `data-model/csv-data/日別訪問計画.csv` |
...
- [x] 要件定義
- [x] ロジック設計
- [x] データモデル設計（マスタ6テーブル + トランザクション1テーブル + PDF起点1テーブル）
- [x] デモデータ作成
...
| [06_患者不在時間](data-model/documentation/06_患者不在時間.md) | 患者不在時間テーブル定義、AppSheet連携式 |
| [07_日別訪問計画](data-model/documentation/07_日別訪問計画.md) | 日別訪問計画テーブル定義、PDF起点レコード |
| [03_PDFテンプレート設計書](documents/03_PDFテンプレート設計書.md) | タイムスケジュールPDFのテンプレート設計 |
